...
//                    .foregroundColor(.black)
                ...
                LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 16) {
                                FeatureButton(title: "Deepen the Connection", icon: "heart.fill")
                                FeatureButton(title: "Strengthen Your Bond", icon: "person.2.fill")
                                FeatureButton(title: "Sustain the Spark", icon: "flame.fill")
                                FeatureButton(title: "Relationship Growth", icon: "arrow.up.right.circle.fill")
                                FeatureButton(title: "Intimacy Builder", icon: "person.2.fill")
                                FeatureButton(title: "Long-Term Love", icon: "infinity.circle.fill")
                            }
                .padding(.horizontal)
                .padding(.bottom)
